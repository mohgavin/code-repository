...
if __name__ == '__main__':
	...
	print('Create Pivot')
	pivot_dl_mean = dask_gdf_dl_throughput.pivot_table(index='geometry_polygon', columns='UE_Throughput-L2100', values='ue_throughput_dl_drb_kbps', aggfunc='mean')
	pivot_dl_count = dask_gdf_dl_throughput.pivot_table(index='geometry_polygon', columns='UE_Throughput-L2100', values='ue_throughput_dl_drb_kbps', aggfunc='count')
