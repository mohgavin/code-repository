...
if __name__ == '__main__':
	...
	grid = dask_pd.read_csv('grid_train/LRT_Polygon.csv')
	...
	dask_gdf_mdt['combined'] = dask_gdf_mdt['site'].astype(str) + "@" + dask_gdf_mdt['id'] + "@" + dask_gdf_mdt['enodebid'].astype(str) + "@" + dask_gdf_mdt['ci'].astype(str) + "@" + dask_gdf_mdt['WKT'].astype(str)
