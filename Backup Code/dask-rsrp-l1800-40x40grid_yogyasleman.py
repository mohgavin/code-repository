...
if __name__ == '__main__':
	...
	print('Loading Files...')
	dask_df_mdt =  dask_pd.read_csv('Compile-MDT-Yogyasleman/mdt*.csv', usecols=[0,1,2,3,4,6,7,8,9], assume_missing=True, dtype={'rsrp_serving': 'object'})
	dask_df_mdt['rsrp-l1800'] = 'rsrp-l1800'

	dask_df_mdt['isnumberic'] = dask_df_mdt['rsrp_serving'].astype(str).str.isnumeric()
	...
	grid = dask_pd.read_parquet('grid_folder/40x40grid_yogyasleman_filtered.parquet')
	...
	print('Saving Files...')	
	#pivot = pivot.compute()
	pivot_mean.to_csv('result/rsrp-l1800-yogyasleman-40x40.csv')
	pivot_count.to_csv('result/rsrp-l1800-yogyasleman-40x40-pop.csv')
