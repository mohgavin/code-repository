...
if __name__ == '__main__':
	...
	print('Create Pivot')
	pivot_mean = dask_gdf_throughput.pivot_table(index='geometry_polygon', columns='UE_Throughput-L1800', values='ue_throughput_dl_drb_kbps', aggfunc='mean')
	pivot_count = dask_gdf_throughput.pivot_table(index='geometry_polygon', columns='UE_Throughput-L1800', values='ue_throughput_dl_drb_kbps', aggfunc='count')
