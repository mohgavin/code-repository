...
def get_data(dict_id):
    ...
    try:
        ...
        #print('   Query success........')
        lte_kpi.saveResult(df, 'daily_cell', s_date2, path_daily)
...
def combineData(list_data):
    ...
    for dict_id in list_data:
        ...
        file = '%s/daily_cell_%s.zip'%(path_daily, s_date2)
    ...
    if len(list_df) > 0:
        ...
        lte_kpi.saveResult(df, 'daily_cell', s_date2, '/var/opt/common5/eniq/lte/raw/daily/all')
        
        #Calculate KPI
        df, df_view = lte_kpi.calculateKPI(df, ['date_id', 'erbs', 'eutrancellfdd', 'eniqid'])
        lte_kpi.saveResult(df, 'lte_cell_daily', s_date2, '/var/opt/common5/eniq/lte/kpi/daily')
        lte_kpi.saveResult(df_view, 'viewLte_cell_daily', s_date2, '/var/opt/common5/eniq/lte/kpi/daily')
