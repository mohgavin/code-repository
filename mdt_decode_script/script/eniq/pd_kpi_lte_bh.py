...
if __name__ == '__main__':
    ...
    for dt in rrule.rrule(rrule.DAILY, dtstart=start_datetime, until=stop_datetime):
        ...
        for hour in range(24):
            file = '/var/opt/common5/eniq/lte/raw/hourly/all/%s/hourly_cell_%s_%02d.zip'%(s_date, s_date, hour)
        ...
        if len(list_df) > 0:
            ...
            id_date = '%s'%(s_date)
            folder = '/var/opt/common5/eniq/lte/kpi/bh'
        ...
        #        folder = '/var/opt/common5/eniq/lte/kpi/hourly/%s' %(s_date)
